...
public sealed class Item
{
    ...
    public Item(PostDto dto)
    {
        Name = dto.ItemName;
        Description = dto.ItemDescription;
        FoundLocation = dto.ItemFoundLocation;
        City = dto.ItemCity;
        DateFound = dto.ItemDateFound.Value;
        ImageUrl = dto.ItemImageUrl;
        Color = dto.ItemColor;
        FoundReference = dto.ItemFoundReference;
    }

    public Item(int id, string name, string description, string? imageUrl, string? color, string foundLocation, string? foundReference, string city, DateOnly dateFound)
    {
    ...
    public Item(string name, string description, string? imageUrl, string? color, string foundLocation, string? foundReference, string city, DateOnly dateFound)
    {
        Validation(name, description, imageUrl, color, foundLocation, foundReference, city, dateFound);
    }
    ...
    [Column("imagem_url")] public string? ImageUrl { get; private set; }
    ...
    private void Validation(string name, string description, string? imageUrl, string? color, string foundLocation, string? foundReference, string city, DateOnly dateFound)
    {
